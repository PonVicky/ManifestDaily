 ...
 * ask, so we gate it to a single lifetime attempt — triggered from the first
 * genuinely positive moment the user hits: completing a focus session or
 * sealing a vault, whichever comes first. Never call this during onboarding,
 * on the paywall, or after an error.
 *
